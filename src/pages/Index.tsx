...
const historyEvents = [
  ...
  },
  {
    ...
    desc: "1–3 мая 2027 года — очередной фестиваль «А музы не молчат!». У Борковского музея вновь зазвучат фронтовые стихи и песни во славу защитников Отечества.",
    icon: "Calendar",
    highlight: true,
  },
]
  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        "Для участия в конкурсной программе необходимо подать заявку с подборкой стихотворений (не менее 3 произведений) на тему фронтовой лирики. Заявки принимаются по электронной почте до 21 марта 2027 года. Для гостей фестиваля вход свободный — приезжайте 1-3 мая в г. Великие Луки и д. Борки Великолукского района.",
    },
    {
    ...
    {
      question: "Что включает программа трёх дней?",
      answer:
        "1 мая: круглый стол с гостями фестиваля и финал конкурса чтецов в Великих Луках. 2 мая: шествие Бессмертного полка русской поэзии и праздник «А музы не молчат!» в д. Борки. 3 мая: экскурсия и возложение цветов к памятнику Воинам СВО, час кино, торжественный гала-концерт фестиваля в Великих Луках.",
    },
  ]
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#f5ead6", color: "#2a1000" }}>
      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-6 pt-20 text-center">
          ...
          {/* Date Block */}
          <a
            href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Фестиваль+«А+музы+не+молчат!»&dates=20270501/20270504&details=Всероссийский+фестиваль+фронтовой+поэзии&location=г.+Великие+Луки+и+д.+Борки,+Великолукский+район,+Псковская+область"
            target="_blank"
          ...
          <div className="rounded-3xl p-10 md:p-14 mb-16" style={{ background: "rgba(180,130,60,0.12)", border: "1px solid rgba(140,90,30,0.2)", backdropFilter: "blur(12px)" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              {[
                ...
                { oid: "-229745853", id: "456239093", hash: "", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239092", hash: "", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239090", hash: "", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239096", hash: "l8uaPwYvQeYm0ozKVV", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239091", hash: "QYRe6W0eb5uKnwf1ZD", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239086", hash: "WNNeOJyAbFcZVQzFwY", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239094", hash: "K5uQmX5miucB9Vk8Zs", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239085", hash: "em7wiPYAXJffswEo6L", title: "Фестиваль «А музы не молчат!»" },
                { oid: "-229745853", id: "456239095", hash: "hYd4uF0smansZ4WqVz", title: "Фестиваль «А музы не молчат!»" },
              ].map((video, i) => (
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                { url: "https://vk.com/video-229745853_456239100", label: "Видео ВКонтакте" },
              ].map((link, i) => (
                <a
                  key={i}
                  href={link.url}
                    ...
                    {[
                      {
                        ...
                        content: (
                          <div className="space-y-2 text-sm leading-relaxed" style={{ color: "#3a1f00" }}>
                            <p>Конкурс проводится один раз в год. С 2027 года добавлена новая номинация — «Авторское стихотворение», в которой определяется лучшее стихотворение, написанное автором от 8 до 18 лет.</p>
                          </div>
                        )
                      },
                      {
                        ...
                        content: (
                          <div className="space-y-2 text-sm leading-relaxed" style={{ color: "#3a1f00" }}>
                            <ul className="space-y-2">
                              <li><span style={{ color: "#c8a020" }}>Период проведения:</span> 17 января — 21 марта 2027 года</li>
                              <li><span style={{ color: "#c8a020" }}>Финальные чтения:</span> 1 мая 2027 года, г. Великие Луки</li>
            ...
            <div className="pt-8" style={{ borderTop: "1px solid rgba(140,90,30,0.2)" }}>
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p className="text-xs" style={{ color: "#8a6030" }}>
                  <a href="https://museum-borki.edusite.ru" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity underline decoration-dotted">Литературно-художественный музей им. И.А. Васильева, д. Борки</a> · 1–3 мая 2027
                </p>
              </div>
            </div>
          </div>
