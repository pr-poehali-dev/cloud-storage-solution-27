    ...
    <div className="min-h-screen" style={{ backgroundColor: "#f5ead6", color: "#2a1000" }}>
      ...
      >
        <div className="flex items-start gap-2">
          {/* Столбик: А музы не молчат + Союз писателей + ЦНТ + Осиянная Русь + Защитники */}
          <div className="flex flex-col items-center gap-1">
            ...
            <img src="https://cdn.poehali.dev/projects/cb5f2151-618e-4458-9342-f98631d4ff88/bucket/9715bd25-a800-4431-99cb-c84bdb9af298.jpg" alt="Псковский областной центр народного творчества" className="w-16 h-10 object-contain drop-shadow-lg" />
          ...
          {/* Горизонтальный ряд: ИКЦ + Администрация + Великие Луки */}
